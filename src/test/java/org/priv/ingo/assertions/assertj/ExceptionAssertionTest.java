...
class ExceptionAssertionTest {
  ...
  @Nested
  @DisplayName("When we write assertions directly to the thrown exception 2")
  ...
  @Nested
  @DisplayName("When we write assertions directly to the thrown exception 3")
  class WhenWeWriteAssertionsForThrownException3 {
